...
]} alt="Prism in Red Dead Redemption 2. © Rockstar Games 2018"/>
...
```hlsl showLineNumbers title="Prism.fx"
...
You might've noticed that the chromatic aberration in Meerkat Demo and Prism isn't quite 1-to-1. That's because I'm a massive fan of anamorphic lenses and the visual artifacts that come along with them. So much so that I even have an anamorphic lens in real life that I occasionally use for photography.
