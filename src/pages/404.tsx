          ...
          <div className="flex flex-col gap-0 space-y-20 m-auto">
            <div className="flex flex-row gap-0">
              <div id="one" className="flex flex-col gap-0">
                ...
                <svg className="h-7.5 fill-foreground" viewBox="-6.8 0 192 30.2">
              ...
              <div id="two" className="flex flex-col gap-0">
                ...
                <svg className="h-7.5 fill-foreground" viewBox="-6.8 0 384 30.2">
            ...
            <section id="cta" className="m-auto">
              <a className="font-mono hover:font-extrabold! transition-varfonts duration-100 text-3xl" onClick={() => navigate(-1)}>
                Let's head back
              </a>
            </section>
          </div>
