...
function DropdownMenuContent({
  ...
  forceMount,
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Content> & React.ComponentProps<typeof DropdownMenuPortal>) {
  return (
...
function DropdownMenuSliderItem({
  ...
  ...props
}: React.ComponentProps<typeof DropdownMenuItem> & React.ComponentProps<typeof Slider> & {
  showValue?: boolean,
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-1.5">
        <span>{children}</span>
        {showValue && <span>{valueFormatter(value[0])}</span>}
      </div>
      <Slider {...props} value={props.value || value} onValueChange={props.onValueChange || setValue} />
    </DropdownMenuItem>
  )
}
